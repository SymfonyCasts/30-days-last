...
make sure to remove `use HasBrowser`:

[[[ code('5ef9014134') ]]]

Then we can tighten things up: reconnect all of these spots... then use
the new method: `->waitForPageLoad()`... with auto-complete! Remove the
`ddScreenshot()`:
